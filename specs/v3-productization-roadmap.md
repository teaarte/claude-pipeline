...
- **Still open (3):** Q9 (under-spawning), Q27 (pre-review infra missing), Q30 (refs-to-load wiring). All three bundled into **v2.2a "review-completeness"** (~5-7d) — next priority.
- **Deferred (1):** Q38 (terminal-tab rename — solved natively by v2.3 Web UI).
- **Separate bundle:** Q1-Q6 code-quality items → `v2.2-code-polish` when convenient.

Total validation-driven backlog: 25 items surfaced across 3 real-task runs. 21 closed, 3 open (review-completeness), 1 deferred.
