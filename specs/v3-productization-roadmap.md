...
- **Closed in v2.2a-review-completeness (6):** Q9, Q27, Q30, Q41, Q42, Q43. All review-surface inputs now wired end-to-end (decisions invoked, refs persisted, pre-review files emitted, slug collisions resolved, metric derivation corrected). Real-task validation pending post-merge.
