...
- **Still open (5):** Q9 (under-spawning), Q27 (pre-review infra missing), Q30 (refs-to-load persistence), Q41 (refs-to-load stack-blind), Q42 (task_id slug collision). First 4 bundled into **v2.2a "review-completeness"** (~6-8d) — next priority; Q42 (~1h) folds in for metric correctness.
...
Total validation-driven backlog: 27 items surfaced across 4 real-task runs (Step 4 added Q41+Q42). 21 closed, 5 open (v2.2a review-completeness), 2 deferred.
