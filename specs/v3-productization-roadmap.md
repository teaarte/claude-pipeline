...
**v2.1-polish-bundle status:** 10 of 22 open items closed (Q8, Q11, Q14, Q17-Q24). **Still open: 12 items** surfaced by 3 real-task validation runs — Q9 (under-spawning), Q10 (cosmetic), Q25 (onboarding friction), Q26 (Q17 partial — stack values), Q27 (pre-review infra missing), Q28 (Q21 partial — schema_version), Q29 (vocab gap), Q30 (refs_loaded empty), Q31 (iterations stale), Q32 (acceptance_first_pass stale), Q33 (files.created/modified empty), Q34 (grounding_check stale). Q1-Q6 code-quality items deferred to separate `v2.2-code-polish` bundle.
