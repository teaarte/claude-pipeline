...
**v2.1-polish-bundle status:** 10 of 13 open items closed (Q8, Q11, Q14, Q17-Q24). **Open:** Q9 (deferred — needs auth/perf real-task profile to surface 5-reviewer fan-out) + Q10 (cosmetic, v1 leftover field — `current_step` stale) + Q25 (onboarding friction — docs-only fix deferred to next bundle). Q1-Q6 (code-quality follow-ups) deferred to a separate `v2.2-code-polish` bundle.
